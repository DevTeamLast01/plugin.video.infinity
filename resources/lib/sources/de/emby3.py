...
class source:
    def __init__(self):
        ...
        ## User Specific ##
        self.name=control.setting('emby.name3')
        self.user=control.setting('emby.user3')
        self.password=control.setting('emby.pass3')
        self.serverip=control.setting('emby.serverip3')
        self.server_port=control.setting('emby.port3')
