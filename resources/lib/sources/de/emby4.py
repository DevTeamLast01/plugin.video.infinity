...
class source:
    def __init__(self):
        ...
        ## User Specific ##
        self.name=control.setting('emby.name4')
        self.user=control.setting('emby.user4')
        self.password=control.setting('emby.pass4')
        self.serverip=control.setting('emby.serverip4')
        self.server_port=control.setting('emby.port4')
