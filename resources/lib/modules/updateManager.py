...
"""
    UpdateManager (C) 2019 new by ka
...
def urlResolverUpdate(silent=False):
    ...
    REMOTE_URLRESOLVER_COMMITS = "https://api.github.com/repos/streamxstream/script.module.urlresolver/commits/master?access_token=fd8bae17378030ed684e7bdc34ae652544904fa9"
    REMOTE_URLRESOLVER_DOWNLOADS = "https://api.github.com/repos/streamxstream/script.module.urlresolver/zipball/master?access_token=fd8bae17378030ed684e7bdc34ae652544904fa9"
    try:
...
def pluginVideoInfinity(silent=False):
    name = 'plugin.video.infinity'
    REMOTE_PLUGIN_COMMITS = "https://api.github.com/repos/deepship/plugin.video.infinity/commits/nightly"
    REMOTE_PLUGIN_DOWNLOADS = "https://api.github.com/repos/deepship/plugin.video.infinity/zipball/nightly"
    try:
...
def devUpdates():
    try:
        ...
        options = ['Beide', 'URL Resolver', 'Infinity']
