...
class source:
    def __init__(self):
        ...
        ## User Specific ##
        self.name=control.setting('emby.name5')
        self.user=control.setting('emby.user5')
        self.password=control.setting('emby.pass5')
        self.serverip=control.setting('emby.serverip5')
        self.server_port=control.setting('emby.port5')
